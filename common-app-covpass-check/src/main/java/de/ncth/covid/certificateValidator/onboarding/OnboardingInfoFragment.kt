...
import de.ncth.covid.commonapp.onboarding.BaseOnboardingConsentFragment
import de.ncth.covid.commonapp.onboarding.BaseOnboardingInfoFragment
 ...
 */
internal class OnboardingInfo0Fragment: CommonOnboardingInfoFragment() {
    override val titleRes = R.string.validation_custom_app_title
    override val textRes = R.string.validation_custom_app_info
    override val imageRes = R.drawable.ic_custom_app
}
