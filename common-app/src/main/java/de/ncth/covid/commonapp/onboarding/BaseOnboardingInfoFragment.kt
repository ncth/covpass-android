...
package de.ncth.covid.commonapp.onboarding
...
import de.ncth.covid.commonapp.databinding.OnboardingInfoBinding
...
public abstract class BaseOnboardingInfoFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.onboardingInfoTextview.setMovementMethod(LinkMovementMethod.getInstance())
    }
}
